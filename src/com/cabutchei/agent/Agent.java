...
public class Agent {
    ...
    public static String startServer(String line) {
        ...
        String pid = Commands.startServer(serverId);
    ...
    public static String addServer(String line) {
        var req = AddServerRequest.fromJson(line);
        if (req.opcode != Opcodes.SERVER_ADD) {
            throw new IllegalArgumentException("Invalid opcode: " + req.opcode);
        }
